...
function format_cvo_upgrade_remove_numsections() {
    ...
    $params = ['format1' => 'cvo', 'format2' => 'cvo', 'numsections' => 'numsections'];
    ...
    foreach ($needfixing as $courseid => $numsections) {
        format_cvo_upgrade_hide_extra_sections($courseid, $numsections);
    }

    $DB->delete_records('course_format_options', ['format' => 'cvo', 'sectionid' => 0, 'name' => 'numsections']);
}
 ...
 */
function format_cvo_upgrade_hide_extra_sections($courseid, $numsections) {
    global $DB;
